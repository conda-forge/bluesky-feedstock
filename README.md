...
Installing bluesky-suite
========================

Installing `bluesky-suite` from the `conda-forge` channel can be achieved by adding `conda-forge` to your channels with:
...
Updating bluesky-suite-feedstock
================================

If you would like to improve the bluesky-suite recipe or build a new
...
Note that all branches in the conda-forge/bluesky-suite-feedstock are
